        ...
        <div className="dashboard-virtueRank">
          ...
          <div className="bg-gray-300 p-6 my-6">
            <label className="text-3xl font-bold">
              Option 3
              <p className="text-2xl font-bold text-blue-700">Courage</p>
          ...
          <div className="bg-gray-300 p-6 my-6">
            <label className="text-3xl font-bold">
              Option 2
              <p className="text-2xl font-bold text-blue-700">Over-Sharing</p>
              <div className="h-24 my-2 flex justify-center items-center bg-white">
                <p className="inline mx-3">Virtue</p>
          ...
          <div className="bg-gray-300 p-6 my-6">
            <label className="text-3xl font-bold">
              Option 1
              <p className="text-2xl font-bold text-blue-700">Blind Devotion</p>
              <div className="h-24 my-2 flex justify-center items-center bg-white">
                <p className="inline mx-3">Virtue</p>
