  ...
  return (
    <div className="site-dashboard">
      ...
      <div className="md:flex">
        <div className="ml-20 mr-10 mt-10 max-h-80 justify-center w-6/12 bg-gray-300 rounded shadow-lg">
        ...
        <div className="ml-10 mr-20 mt-10 pb-4 justify-center w-6/12 bg-gray-300 rounded shadow-lg">
          <div className="p-4 justify-center">
            <label className="text-3xl font-bold">
          ...
          <div className="my-2 min-h-32 max-h-128 overflow-y-auto">
