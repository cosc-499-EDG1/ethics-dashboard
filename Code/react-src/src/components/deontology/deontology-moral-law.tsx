    ...
    <div className="site-dashboard">
      ...
      <div className="md:flex">
        <div className="md:block w-6/12">
          <div className="ml-20 mr-10 mt-10 h-auto justify-center bg-gray-300 rounded shadow-lg">
          ...
          <div className="ml-20 mr-10 mt-5 h-auto justify-center bg-gray-300 rounded shadow-lg">
            <div className="p-4 justify-between">
          ...
          <div className="ml-20 mr-10 mt-2 h-auto justify-center bg-gray-300 rounded shadow-lg">
            <div className="p-4 justify-between">
              <label className="text-2xl font-bold">
        ...
        <div className="md:block w-6/12">
          <div className="ml-10 mr-20 mt-10 pb-4 justify-center bg-gray-300 rounded shadow-lg">
            <div className="p-4 justify-center">
              <p className="text-4xl font-bold text-center">Option 2</p>
            </div>
