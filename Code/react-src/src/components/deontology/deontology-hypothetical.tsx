...
const DeontologyHypothetical: FunctionComponent<DeontologyHypotheticalProps> = () => {
    return(
        <div className="site-dashboard">
            <div className="dashboard-title">
                ...
                <div className="dashboard-title-description">
                    ...
                    <p>You study because you have a goal or a desire – to do well on the midterm. Hypothetical imperatives are 
                    commands that tell us what we should do, but they do not express moral laws.</p>
                </div>
            </div>
            <div className="pt-30">
                <p>
            ...
            <div className="md:flex">
                <div className="dashboard-hypotheticalblock">
                    ...
                    <div className="dashboard-hypothetical">
                        <label className="text-3xl font-bold">
                        These motivations are consistent with hypothetical reasoning and therefore cannot be a universal law of moral action.
                        </label>
                    </div>
                </div>
                    ...
                    <div className="bg-gray-300 p-6 my-6">
                        <label className="text-3xl font-bold">
                            ...
                            <div className="h-24 my-2 flex justify-center items-center bg-white">
                                <p className="inline mx-3 text-lg text-black">This reasoning is consistent with hypothetical reasoning and 
                                therefore cannot support a moral action.</p>
                            </div>
                        </label>
                    </div>
                    <div className="bg-gray-300 p-6 my-6">
